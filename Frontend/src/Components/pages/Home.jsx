    ...
    {[
      {
        ...
        icon: (
          <svg viewBox="0 0 24 24" className="help-svg"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg>
        )
      },
      {
        num: "02",
        ...
        icon: (
          <svg viewBox="0 0 24 24" className="help-svg"><path d="M23 7l-7 5 7 5V7z"/><rect x="1" y="5" width="15" height="14" rx="2"/></svg>
        )
      },
      {
        num: "03",
        ...
        icon: (
          <svg viewBox="0 0 24 24" className="help-svg">
      ...
      },
      {
        ...
        icon: (
          <svg viewBox="0 0 24 24" className="help-svg"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
        )
      }
    ].map((step) => (
